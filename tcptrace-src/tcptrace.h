...
//Oana----
extern FILE *myrawpktsfile;
extern FILE *myrttfile;
extern FILE *mytsgfile;
extern FILE *myssizefile;
extern FILE *myowinfile;
extern FILE *mytlinefile;
extern FILE *mytputfile;
extern FILE *mycontentsfile;
//-----
...
#define SEGS_TO_REMEMBER 8
    ...
    //Oana--- data structures for calculating the throughput for one second bin
    u_long	thru_bin_firsttime;	/* time of first packet this bin */
    u_long	thru_bin_bytes;	/* number of bytes this bin */
    u_long	thru_bin_pkts;	/* number of packets this bin */
    timeval	thru_bin_lasttime;	/* time of previous bin */

    //count from the beginning of the connction
    timeval	thru_stat_firsttime;	/* time of previous bin - for min, max, avg*/
    timeval	thru_stat_lasttime;	/* time of first packet this bin - for min, max, avg */
    u_long	thru_stat_bytes;	/* number of bytes this bin */
    u_long	thru_stat_pkts;	/* number of packets this bin */
    u_long	thru_stat_min;
    u_long	thru_stat_max;
    double	thru_stat_sum;	/* for averages */
    double	thru_stat_sum2;	/* sum of squares, for stdev */
    u_long	thru_stat_count;	/* for averages */
    double thru_debug;
    //---
...
typedef struct ucb {
    ...
    u_long	min_dg_size;
    u_long	max_dg_size;
    //Oana-- add same things as for TCP
    /* host name letter(s) */
    char	*host_letter;
    /* Instantaneous throughput info */
      timeval	thru_firsttime;	/* time of first packet this interval */
...
//Oana--- add timeseries files extantions
#define TSR_RTT_GRAPH_FILE_EXTENSION	"_rtt.dat"
#define TSR_THROUGHPUT_FILE_EXTENSION	"_tput.dat"
#define TSR_PLOT_FILE_EXTENSION		"_tsg.dat"
#define TSR_OWIN_FILE_EXTENSION		"_owin.dat"
#define TSR_RAW_FILE_EXTENSION      "_raw.dat"
